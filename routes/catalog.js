...
// GET request to delete Book.https://www.youtube.com/watch?v=lmqAosIKkEY
...
router.get('/catalog/book/:id', book_controller.book_detail);
...
router.get('/catalog/author/:id', author_controller.author_detail);
...
router.get('/catalog/genre/:id', genre_controller.genre_detail);
...
router.get('/catalog/bookinstance/:id', book_instance_controller.bookinstance_detail);
